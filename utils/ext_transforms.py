...
class ExtRandomHorizontalFlip(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        if random.random() < self.p:
            return F.hflip(img), F.hflip(lbl), F.hflip(sal)
        return img, lbl, sal
...
class ExtCenterCrop(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        return F.center_crop(img, self.size), \
                F.center_crop(lbl, self.size), \
                F.center_crop(sal, self.size)
...
class ExtRandomRotation(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        return F.rotate(img, angle, self.resample, self.expand, self.center), \
                ...
                F.rotate(sal, angle, self.resample, self.expand, self.center)
...
class ExtRandomVerticalFlip(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        """
        if random.random() < self.p:
            return F.vflip(img), F.vflip(lbl), F.vflip(sal)
        return img, lbl, sal
...
class ExtPad(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        sal = F.pad(sal, ( pw//2, pw-pw//2, ph//2, ph-ph//2))
        return im, lbl, sal
    ...
    def __call__(self, pic, lbl, sal):
        ...
        if self.normalize:
            return F.to_tensor(pic), \
                    ...
                    torch.from_numpy( np.array( sal, dtype=self.target_type) )
        else:
...
class ExtNormalize(object):
    ...
    def __call__(self, tensor, lbl, sal):
        """
        Args:
        ...
        """
        return F.normalize(tensor, self.mean, self.std), lbl, sal
...
class ExtRandomCrop(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        return F.crop(img, i, j, h, w), F.crop(lbl, i, j, h, w), F.crop(sal, i, j, h, w)
...
class ExtResize(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        return F.resize(img, self.size, self.interpolation), \
                ...
                F.resize(sal, self.size, Image.NEAREST)
